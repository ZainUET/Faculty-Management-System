namespace DB_Mid_Project.UI
{
    partial class UpdateSemester
    {
        ...
        private void InitializeComponent()
        {
            ...
            panel4.Controls.Add(year);
            panel4.Controls.Add(semesters);
            panel4.Controls.Add(add_course);
            panel4.Controls.Add(label5);
            panel4.Controls.Add(newsemester);
            ...
            // semesters
            // 
            semesters.Cursor = Cursors.Hand;
            semesters.Font = new Font("Arial", 9F);
            semesters.FormattingEnabled = true;
            semesters.Location = new Point(84, 80);
            semesters.Name = "semesters";
            semesters.Size = new Size(260, 23);
            semesters.TabIndex = 41;
            // 
            // add_course
            // 
            ...
            add_course.Text = "Update Semester";
            ...
            // newsemester
            // 
            newsemester.Cursor = Cursors.Hand;
            newsemester.Font = new Font("Arial", 9F);
            newsemester.FormattingEnabled = true;
            newsemester.Location = new Point(84, 145);
            newsemester.Name = "newsemester";
            newsemester.Size = new Size(260, 23);
            newsemester.TabIndex = 37;
            // 
            // femailicon
            // 
            femailicon.AutoSize = true;
            femailicon.Font = new Font("Segoe UI", 12F);
            femailicon.Location = new Point(43, 209);
            ...
            fnameicon.Location = new Point(46, 82);
            ...
            H1.Location = new Point(84, 21);
            H1.Name = "H1";
            H1.Size = new Size(237, 30);
            H1.TabIndex = 26;
            H1.Text = "Update Semester ";
            // 
            // logout
            // 
            ...
            // year
            // 
            year.Location = new Point(84, 207);
            year.Name = "year";
            year.Size = new Size(260, 23);
            year.TabIndex = 42;
            // 
            // UpdateSemester
            // 
