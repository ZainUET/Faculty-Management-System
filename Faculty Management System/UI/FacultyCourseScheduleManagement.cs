...
{
    public partial class FacultyCourseScheduleManagement : Form
    {
        public FacultyCourseScheduleManagement()
        {
            InitializeComponent();
        }
        ...
        private void addmember_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            ...
            ScheduleCourseForFaculty addForm = new ScheduleCourseForFaculty();
            this.Hide();
            addForm.ShowDialog();
            this.Close();
        }
        ...
        private void removemember_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            ...
            RemoveFacultyCourseSchedules addForm = new RemoveFacultyCourseSchedules();
            this.Hide();
            addForm.ShowDialog();
            this.Close();
        }
        ...
        {
            ViewFacultyCourseSchedules showForm = new ViewFacultyCourseSchedules();
            this.Hide();
            showForm.ShowDialog();
            this.Close();
        }
