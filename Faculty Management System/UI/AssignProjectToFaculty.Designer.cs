...
{
    partial class AssignProjectToFaculty
    {
        /// <summary>
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(AssignProjectToFaculty));
            panel2 = new Panel();
            ...
            panel4 = new Panel();
            label5 = new Label();
            supervisionHoursNumericUpDown = new NumericUpDown();
            label4 = new Label();
            label3 = new Label();
            label2 = new Label();
            ...
            ((System.ComponentModel.ISupportInitialize)supervisionHoursNumericUpDown).BeginInit();
            SuspendLayout();
            // 
            // panel2
            // 
            ...
            panel4.Controls.Add(supervisionHoursNumericUpDown);
            panel4.Controls.Add(label4);
            panel4.Controls.Add(label3);
            panel4.Controls.Add(label2);
            panel4.Controls.Add(semesterComboBox);
            panel4.Controls.Add(projectComboBox);
            panel4.Controls.Add(assignButton);
            ...
            // 
            // supervisionHoursNumericUpDown
            // 
            supervisionHoursNumericUpDown.Location = new Point(70, 302);
            supervisionHoursNumericUpDown.Name = "supervisionHoursNumericUpDown";
            supervisionHoursNumericUpDown.Size = new Size(267, 23);
            supervisionHoursNumericUpDown.TabIndex = 47;
            // 
            // label4
            // 
            ...
            // projectComboBox
            // 
            projectComboBox.Cursor = Cursors.Hand;
            projectComboBox.Font = new Font("Arial", 9F);
            projectComboBox.FormattingEnabled = true;
            projectComboBox.Location = new Point(70, 158);
            projectComboBox.Name = "projectComboBox";
            projectComboBox.Size = new Size(267, 23);
            projectComboBox.TabIndex = 42;
            // 
            // assignButton
            // 
            assignButton.Cursor = Cursors.Hand;
            assignButton.FlatStyle = FlatStyle.Flat;
            assignButton.Font = new Font("Arial Rounded MT Bold", 10F);
            assignButton.Location = new Point(70, 363);
            assignButton.Name = "assignButton";
            assignButton.Size = new Size(267, 31);
            assignButton.TabIndex = 41;
            ...
            H1.Name = "H1";
            H1.Size = new Size(210, 30);
            H1.TabIndex = 26;
            H1.Text = "Assign Project  ";
            // 
            // backLinkLabel
            // 
            ...
            Controls.Add(panel1);
            Controls.Add(panel2);
            Name = "AssignProjectToFaculty";
            Text = "Assign Project To Faculty";
            ...
            ((System.ComponentModel.ISupportInitialize)supervisionHoursNumericUpDown).EndInit();
            ResumeLayout(false);
            PerformLayout();
        }
        ...
        private NumericUpDown supervisionHoursNumericUpDown;
    }
}